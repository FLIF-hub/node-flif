...
:--                       | :--                | :--               | :--              | :--                                                                                                  | :--
Transcode                 | input (transcode)  | N/A               | array of strings | String must be a valid path ending in `.flif`                                                        | Path to location of FLIF file
           Decode         | input (decode)     | N/A               | array of strings | String must be a valid path ending in `.flif`                                                        | Path to location of FLIF file
                   Encode | input (encode)     | N/A               | array of strings | Strings can be any valid path ending in one of these: `.png`, `.pnm`, `.ppm`, `.pgm`, `.pbm`, `.pam` | Array of input files for frames
Transcode                 | output (transcode) | N/A               | string           | String must be a valid path ending in `.flif`                                                        | Path to the location of where the output file should be created
           Decode         | output (decode)    | N/A               | string           | Strings can be any valid path ending in one of these: `.png`, `.pnm`, `.ppm`, `.pgm`, `.pbm`, `.pam` | Path to the location of where the output file should be created
                   Encode | output (encode)    | N/A               | string           | String must be a valid path ending in `.flif`                                                        | Path to the location of where the output file should be created
