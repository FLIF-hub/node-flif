...
:--                       | :--              | :--               | :--              | :--                                                                                                  | :--
Transcode                 | input            | N/A               | array of strings | String must be a valid path ending in `.flif`                                                        | Path to location of FLIF file
Decode                    | input            | N/A               | array of strings | String must be a valid path ending in `.flif`                                                        | Path to location of FLIF file
Encode                    | input            | N/A               | array of strings | Strings can be any valid path ending in one of these: `.png`, `.pnm`, `.ppm`, `.pgm`, `.pbm`, `.pam` | Array of input files for frames
...
Decode                    | output           | N/A               | string           | Strings can be any valid path ending in one of these: `.png`, `.pnm`, `.ppm`, `.pgm`, `.pbm`, `.pam` | Path to the location of where the output file should be created
