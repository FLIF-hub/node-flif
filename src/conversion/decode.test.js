...
function test () {
    ...
    var testData = [
        ...
        { expectation: '-d -k "a.flif" "b.png"',     params: {input:'a.flif', output:'b.png', keepPalette: true           } },
        { expectation: '-d "a.flif" "b.png"',        params: {input:'a.flif', output:'b.png', keepPalette: false          } },
