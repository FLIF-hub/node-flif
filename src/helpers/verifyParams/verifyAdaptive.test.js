...
function test () {
    ...
    var testData = [
        ...
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.flif', encodeQuality: 9, adaptive: 'c.png'   }, 'transcode', true]},
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.png',  encodeQuality: 9, adaptive: 'c.png'   }, 'decode',    true]},
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.flif', encodeQuality: 9, adaptive: 'c.pnm'   }, 'transcode', true]},
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.png',  encodeQuality: 9, adaptive: 'c.pnm'   }, 'decode',    true]},
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.flif', encodeQuality: 9, adaptive: 'c.ppm'   }, 'transcode', true]},
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.png',  encodeQuality: 9, adaptive: 'c.ppm'   }, 'decode',    true]},
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.flif', encodeQuality: 9, adaptive: 'c.pgm'   }, 'transcode', true]},
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.png',  encodeQuality: 9, adaptive: 'c.pgm'   }, 'decode',    true]},
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.flif', encodeQuality: 9, adaptive: 'c.pbm'   }, 'transcode', true]},
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.png',  encodeQuality: 9, adaptive: 'c.pbm'   }, 'decode',    true]},
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.flif', encodeQuality: 9, adaptive: 'c.pam'   }, 'transcode', true]},
        { expected: false, arguments: [{ input: 'a.flif', output: 'a.png',  encodeQuality: 9, adaptive: 'c.pam'   }, 'decode',    true]},
        { expected: false, arguments: [{ input:['a.flif'], output:'a.flif', encodeQuality: 9, adaptive: 'c.png'   }, 'transcode', true]},
        { expected: false, arguments: [{ input:['a.flif'], output:'a.png',  encodeQuality: 9, adaptive: 'c.png'   }, 'decode',    true]},
        { expected: false, arguments: [{ input:['a.flif'], output:'a.flif', encodeQuality: 9, adaptive: 'c.pnm'   }, 'transcode', true]},
        { expected: false, arguments: [{ input:['a.flif'], output:'a.png',  encodeQuality: 9, adaptive: 'c.pnm'   }, 'decode',    true]},
